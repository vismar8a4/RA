...
namespace easyar
{
    ...
    public class ImageTargetControllerEditor : Editor
    {
        ...
        static void DrawGizmo(ImageTargetController scr, GizmoType gizmoType)
        {
            ...
            {
                case ImageTargetController.DataSource.ImageFile:
                    if (EasyARController.Settings && !EasyARController.Settings.GizmoConfig.ImageTarget.EnableImageFile) { return; }
                    signature += scr.ImageFileSource.PathType.ToString() + scr.ImageFileSource.Path;
                    break;
                case ImageTargetController.DataSource.TargetDataFile:
                    if (EasyARController.Settings && !EasyARController.Settings.GizmoConfig.ImageTarget.EnableTargetDataFile) { return; }
                ...
                case ImageTargetController.DataSource.Target:
                    if (EasyARController.Settings && !EasyARController.Settings.GizmoConfig.ImageTarget.EnableTarget) { return; }
                    if (scr.Target != null)
                    {
